...
local BLOCKED_COUNTRIES = utils.parse_list("US,UK")
local BLOCKED_RBL = utils.parse_list("firehol_level1")
local TRUSTED = utils.parse_list("lan_bypass")
...
if cached then
    ...
    local res, err = httpc:request_uri("http://host.docker.internal:3001/api/ip/info/" .. ip, {
        method = "GET",
        headers = {
            ["content-type"] = "application/json",
            ["x-api-key"] = "tZzDBUSnoy76LLSvu1Vg3e9vdFJINMT2",
        },
    })
