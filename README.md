...
[This project](https://nxguard.app.br) aims to create a secure and efficient environment for API exposure, essential for organizations looking to
...
services:
  proxy:
    depends_on:
      - db
    image: liberatti/nxguard:v1.0.2-rc
    environment:
      MONGO_HOST: db
      MONGO_PORT: 27017
      MONGO_DB: nxguard
  ...
  db:
    ...
    environment:
      MONGO_INITDB_ROOT_USERNAME: nxguard_usr
